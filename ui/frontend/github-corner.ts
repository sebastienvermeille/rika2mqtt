...
/**
 * Port of https://eugena.github.io/github-animated-corners/ for Vaadin
 */
...
export class GithubCorner extends LitElement {
    ...
    render() {
        return html`
            <a target="_blank" href="https://github.com/sebastienvermeille/rika2mqtt" class="github-corner"
               aria-label="View source on GitHub"
               title="View source on GitHub">
                <svg xmlns="http://www.w3.org/2000/svg" style="fill:#24292e; color:#fff; position: absolute; top: 0; right: 0"
                     viewBox="0 0 250 250" fill="#151513" height="80" width="80">
                    <path fill="#24292e" class="octo-background"
