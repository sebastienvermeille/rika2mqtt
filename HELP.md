...
* The following dependencies are not known to work with Spring Native: 'Quartz Scheduler, Spring Boot DevTools'. As a result, your application may not work as expected.
...
```
$ docker run --rm rika2mqtt:0.0.1-SNAPSHOT
```
