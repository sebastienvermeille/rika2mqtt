...
import static ch.svermeille.rika.health.service.PingUtils.pingHost;
...
public class MqttConnectivityCheckImpl implements HealthCheck, Runnable {
  ...
  private boolean isHostReachable() {
    return pingHost(this.mqttConfigProperties.getHost(), this.mqttConfigProperties.getPort(), Duration.ofSeconds(10));
  }
