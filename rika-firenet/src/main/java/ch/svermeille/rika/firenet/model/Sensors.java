...
public class Sensors {
  ...
  @SerializedName("parameterVersionTFTBootLoader")  // for coherence (the rest of the api is using camelCase)
  private Integer parameterVersionTftBootLoader;

  @SerializedName("parameterVersionWiFiBootLoader")  // for coherence (the rest of the api is using camelCase)
  private Integer parameterVersionWifiBootLoader;
  private Integer parameterVersionMainBoardSub;

  @SerializedName("parameterVersionTFTSub")  // for coherence (the rest of the api is using camelCase)
  private Integer parameterVersionTftSub;

  @SerializedName("parameterVersionWiFiSub")  // for coherence (the rest of the api use Wifi not WiFi)
